              ...
              {#if hwStore.info}
                <div class="hw-grid">
                  ...
                  <div class="hw-row">
                    ...
                    <span class="hw-val">{hwStore.info.vram_mb != null ? (hwStore.info.vram_mb / 1024).toFixed(1) + ' GB' : 'unknown'}</span>
                  </div>
                  <div class="hw-row">
                    <span class="hw-label">RAM</span>
                    <span class="hw-val">{hwStore.info.ram_mb != null ? (hwStore.info.ram_mb / 1024).toFixed(1) + ' GB' : 'unknown'}</span>
                  </div>
                </div>
              {:else}
